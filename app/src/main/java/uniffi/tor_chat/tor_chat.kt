...
open class RustBuffer : Structure() {
    ...
    companion object {
        ...
        internal fun free(buf: RustBuffer.ByValue) = uniffiRustCall() { status ->
            UniffiLib.INSTANCE.ffi_tor_chat_rustbuffer_free(buf, status)
        }
    }
...
internal interface UniffiCallbackInterfaceOnEventMethod0 : com.sun.jna.Callback {
    fun callback(`uniffiHandle`: Long,`s`: RustBuffer.ByValue,`uniffiOutReturn`: Pointer,uniffiCallStatus: UniffiRustCallStatus,)
}
@Structure.FieldOrder("newMessage", "uniffiFree")
internal open class UniffiVTableCallbackInterfaceOnEvent(
    @JvmField internal var `newMessage`: UniffiCallbackInterfaceOnEventMethod0? = null,
    @JvmField internal var `uniffiFree`: UniffiCallbackInterfaceFree? = null,
) : Structure() {
    class UniffiByValue(
        `newMessage`: UniffiCallbackInterfaceOnEventMethod0? = null,
...
internal interface IntegrityCheckingUniffiLib : Library {
    ...
    fun uniffi_tor_chat_checksum_func_get_public_key_from_onion_address(
    ): Short
    fun uniffi_tor_chat_checksum_func_verify_signature(
    ): Short
    ...
    fun uniffi_tor_chat_checksum_method_messagingclient_send_message_inner(
    ): Short
    fun uniffi_tor_chat_checksum_method_messagingclient_subscribe(
    ): Short
    fun uniffi_tor_chat_checksum_constructor_messagingclient_new(
    ): Short
    fun uniffi_tor_chat_checksum_method_onevent_new_message(
    ): Short
...
private fun uniffiCheckApiChecksums(lib: IntegrityCheckingUniffiLib) {
    ...
    if (lib.uniffi_tor_chat_checksum_func_get_onion_address() != 63397.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_tor_chat_checksum_func_get_public_key_from_onion_address() != 3261.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_tor_chat_checksum_func_verify_signature() != 26717.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_tor_chat_checksum_method_messagingclient_onion_service_from_esk() != 13014.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    ...
    if (lib.uniffi_tor_chat_checksum_constructor_messagingclient_new() != 49409.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
...
open class MessagingClient: Disposable, AutoCloseable, MessagingClientInterface
{
        ...
        override fun run() {
            pointer?.let { ptr ->
                uniffiRustCall { status ->
                    UniffiLib.INSTANCE.uniffi_tor_chat_fn_free_messagingclient(ptr, status)
                }
            }
        }
    }
    ...
    fun uniffiClonePointer(): Pointer {
        return uniffiRustCall() { status ->
            UniffiLib.INSTANCE.uniffi_tor_chat_fn_clone_messagingclient(pointer!!, status)
        }
    }
 ...
 * @suppress
 */
public object FfiConverterTypeMessagingClient: FfiConverter<MessagingClient, Pointer> {

    override fun lower(value: MessagingClient): Pointer {
        return value.uniffiClonePointer()
    }

    override fun lift(value: Pointer): MessagingClient {
        return MessagingClient(value)
    }

    override fun read(buf: ByteBuffer): MessagingClient {
        // The Rust code always writes pointers as 8 bytes, and will
        // fail to compile if they don't fit.
        return lift(Pointer(buf.getLong()))
    }

    override fun allocationSize(value: MessagingClient) = 8UL

    override fun write(value: MessagingClient, buf: ByteBuffer) {
...
internal object uniffiCallbackInterfaceOnEvent {
    internal object `newMessage`: UniffiCallbackInterfaceOnEventMethod0 {
        override fun callback(`uniffiHandle`: Long,`s`: RustBuffer.ByValue,`uniffiOutReturn`: Pointer,uniffiCallStatus: UniffiRustCallStatus,) {
            val uniffiObj = FfiConverterTypeOnEvent.handleMap.get(uniffiHandle)
            val makeCall = { ->
                uniffiObj.`newMessage`(
                    FfiConverterTypeChatMessage.lift(`s`),
                )
            }
    ...
    internal object uniffiFree: UniffiCallbackInterfaceFree {
        override fun callback(handle: Long) {
            FfiConverterTypeOnEvent.handleMap.remove(handle)
        }
    }

    internal var vtable = UniffiVTableCallbackInterfaceOnEvent.UniffiByValue(
        `newMessage`,
        uniffiFree,
    )
    ...
    internal fun register(lib: UniffiLib) {
        lib.uniffi_tor_chat_fn_init_callback_vtable_onevent(vtable)
    }
}
 ...
 * @suppress
 */
public object FfiConverterTypeOnEvent: FfiConverterCallbackInterface<OnEvent>()
